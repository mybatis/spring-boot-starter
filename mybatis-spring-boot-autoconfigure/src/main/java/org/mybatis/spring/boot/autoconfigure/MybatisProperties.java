...
public class MybatisProperties {
    ...
    /**
     * The customize Mapper bean name generator class
     *
     * @see org.mybatis.spring.mapper.MapperScannerConfigurer#setNameGenerator(BeanNameGenerator)
     */
    private Class<? extends BeanNameGenerator> beanNameGenerator;
    ...
    public Class<? extends BeanNameGenerator> getBeanNameGenerator() {
