...
public class MybatisAutoConfiguration implements InitializingBean {
    ...
    public static class AutoConfiguredMapperScannerRegistrar
        ...
        public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
            ...
            MybatisProperties mybatisProperties = binder.bind(MybatisProperties.MYBATIS_PREFIX, MybatisProperties.class).orElseGet(MybatisProperties::new);

            Optional.ofNullable(mybatisProperties.getBeanNameGenerator()).ifPresent(beanNameGenerator -> builder.addPropertyValue("nameGenerator", BeanUtils.instantiateClass(beanNameGenerator)));
